...
import com.interest.myapplication.biz.NewsActivityBiz;
...
public class NewsActivity extends AppCompatActivity{
	...
	private void updateNewsContent() {
		...
		DisplayImageOptions options = new DisplayImageOptions.Builder()
				...
				.cacheOnDisc(true)
				.build();
		imageLoader.displayImage(newsContent.getImage(), ivTitle,options);
	...
	public void save(){
		try{
			...
			if (result){
				Toast.makeText(NewsActivity.this, R.string.save_success,Toast.LENGTH_SHORT).show();
			}else{
				Toast.makeText(NewsActivity.this, R.string.is_save,Toast.LENGTH_SHORT).show();
			}
	...
	class NABroadcastReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (Constant.ACTION_LOAD_NEWS_CONTENT_SUCCESS.equals(action)
				...
				Snackbar.make(mWebView,R.string.network_is_not_connected_and_load, Snackbar.LENGTH_SHORT).show();
			}
		}
	}
}
